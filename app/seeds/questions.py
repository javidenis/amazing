...
def seed_questions():
  question1 = Question(title='Weird question in case I get stranded during war', content='If a military aircraft crashes into enemy territory, does it have to be destroyed by the crew?', user_id= 1)
  ...
  question5 = Question(title="I'm afraid of China", content="China's third aircraft carrier has been launched. Should we sink it before it goes into service?", user_id= 1)
